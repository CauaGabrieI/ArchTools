...
module_registry_init() {
  ...
  module_register gaming "Gaming usage profile planning" profile plan,execute,validate "usage_profile_gaming,driver_packages,execute_plan,validate_plan" no yes
